...
export default function LayersModal({
  ...
  const [baseLayerValue, setBaseLayerValue] = useState(
    localStorage.getItem("baselayer") != "sat" &&
      localStorage.getItem("baselayer") != "topo" &&
      localStorage.getItem("baselayer") != "dark"
      ? "STRE"
